export default {
  header: {
    subtitle: "Powered by TDCDev · hackIAthon 2026",
    myPlan: "My plan",
    loading: "Loading…",
  ...
  drawer: {
    ...
    empty: "You don't have<br>any saved consultations yet",
    clear: "Clear history",
    clearConfirm: "Clear all consultation history?",
    clearConfirmMsg: "This will permanently delete all saved consultations and cannot be undone.",
    deleteSession: "Delete consultation",
  ...
  estimate: {
    ...
    youPay: "You only pay",
    youSave: "you save",
    vs: "vs. the most expensive",
    noHospital:
      "No hospital in the network covers this specialty. Contact your insurer.",
    hospital: "Hospital",
    price: "Price",
    coverage: "Coverage",
    copago: "Your copay",
  ...
  urgency: {
    label: "URGENT",
    message:
      "The severity of the symptoms requires immediate attention. Go to the emergency room of the nearest hospital <strong>right now</strong>.",
  },
};
