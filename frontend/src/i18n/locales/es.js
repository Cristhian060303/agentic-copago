export default {
  ...
  drawer: {
    ...
    empty: "Aún no tienes<br>conversaciones guardadas",
    clear: "Borrar historial",
    clearConfirm: "¿Borrar todo el historial de conversaciones?",
    clearConfirmMsg: "Esta acción eliminará todas las conversaciones guardadas y no se puede deshacer.",
    deleteSession: "Eliminar conversación",
    deleteSessionConfirm: "¿Eliminar esta conversación del historial?",
